    ...
    stage('Docker Image Building') {
        ...
        stage('Docker Image Pushing') {
            steps {
                ...
                docker push ${DOCKER_IMAGE_OWNER}/k8s-frontend:${DOCKER_BUILD_TAG}
                docker push ${DOCKER_IMAGE_OWNER}/k8s-admin:${DOCKER_BUILD_TAG}
                docker push ${DOCKER_IMAGE_OWNER}/k8s-visitor:${DOCKER_BUILD_TAG}
                '''
            }
        }
